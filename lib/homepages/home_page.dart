...
import 'bottomnavigatorbar/profil.dart';
                  ...
                  children: <Widget>[
                    MaterialButton(
                      ...
                      child:Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          Icon(Icons.account_box,color:currentTab==3?Colors.black: Colors.grey),
                          Text('Profil',style: TextStyle(color:currentTab==3?Colors.black: Colors.grey),),
                        ],
                      ),
                    ),
                  ],
